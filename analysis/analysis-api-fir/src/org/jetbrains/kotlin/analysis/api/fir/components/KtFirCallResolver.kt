...
internal class KtFirCallResolver(
    ...
    private fun createKtCall(
        ...
        //  body resolve phase?
        val substitutor =
            (fir as? FirQualifiedAccessExpression)?.createSubstitutorFromTypeArguments(targetSymbol) ?: KtSubstitutor.Empty(token)
    ...
    private fun getInitializerOfReferencedLocalVariable(variableReference: FirExpression): FirFunctionCall? {
        val qualifiedAccess = variableReference as? FirQualifiedAccessExpression
