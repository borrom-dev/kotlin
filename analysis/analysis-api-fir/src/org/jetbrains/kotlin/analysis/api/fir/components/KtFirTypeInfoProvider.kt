...
internal class KtFirTypeInfoProvider(
    ...
    override fun getFunctionClassKind(type: KtType): FunctionalTypeKind? {
        ...
        return when (coneType.functionalTypeKind(analysisSession.useSiteSession)) {
            FunctionalTypeKind.Function -> FunctionalTypeKind.Function
            FunctionalTypeKind.KFunction -> FunctionalTypeKind.KFunction
            FunctionalTypeKind.SuspendFunction -> FunctionalTypeKind.SuspendFunction
            FunctionalTypeKind.KSuspendFunction -> FunctionalTypeKind.KSuspendFunction
            null -> null
