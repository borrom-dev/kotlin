 ...
 * Km data structures represent Kotlin declarations and offer variety of properties to study and alter them.
 * Note that parsing may be lazy, depending on the implementation; therefore, one may not see a [IllegalArgumentException] indicating malformed metadata
 * until one calls `toKmSomething` method.
 */
