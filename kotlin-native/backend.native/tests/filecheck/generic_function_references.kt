...
// CHECK: [[unboxedIndex:%[0-9]+]] = call i32 @"kfun:kotlin#<Int-unbox>(kotlin.Any){}kotlin.Int"(%struct.ObjHeader* [[boxedIndex]])
// CHECK: call %struct.ObjHeader* @"kfun:$get$FUNCTION_REFERENCE$1.invoke#internal"(%struct.ObjHeader* [[this]], %struct.ObjHeader* [[array]], i32 [[unboxedIndex]], %struct.ObjHeader** [[ret]])
...
// CHECK-SAME: (%struct.ObjHeader* [[this:%[0-9]+]], %struct.ObjHeader* [[array:%[0-9]+]], i32 [[index:%[0-9]+]])
// CHECK: [[boxedRetVal:%[0-9]+]] = call %struct.ObjHeader* @Kotlin_Array_get(%struct.ObjHeader* [[array]], i32 [[index]], %struct.ObjHeader** {{%[0-9]+}})
// CHECK: call i32 @"kfun:kotlin#<Int-unbox>(kotlin.Any){}kotlin.Int"(%struct.ObjHeader* [[boxedRetVal]])
...
// CHECK-SAME: (%struct.ObjHeader* [[this:%[0-9]+]], %struct.ObjHeader* [[array:%[0-9]+]], %struct.ObjHeader* [[boxedIndex:%[0-9]+]], %struct.ObjHeader** [[ret:%[0-9]+]])
// CHECK: [[unboxedIndex:%[0-9]+]] = call i32 @"kfun:kotlin#<Int-unbox>(kotlin.Any){}kotlin.Int"(%struct.ObjHeader* [[boxedIndex]])
// CHECK: [[unboxedRetVal:%[0-9]+]] = call i32 @"kfun:$get$FUNCTION_REFERENCE$3.invoke#internal"(%struct.ObjHeader* [[this]], %struct.ObjHeader* [[array]], i32 [[unboxedIndex]])
// CHECK: call %struct.ObjHeader* @"kfun:kotlin#<Int-box>(kotlin.Int){}kotlin.Any"(i32 [[unboxedRetVal]], %struct.ObjHeader** [[ret]])
...
// CHECK-SAME: (%struct.ObjHeader* [[this:%[0-9]+]], i32 [[p1:%[0-9]+]], i32 [[p2:%[0-9]+]])
// CHECK: [[boxedP1:%[0-9]+]] = call %struct.ObjHeader* @"kfun:kotlin#<Int-box>(kotlin.Int){}kotlin.Any"(i32 [[p1]], %struct.ObjHeader** {{%[0-9]+}})
// CHECK: [[boxedP2:%[0-9]+]] = call %struct.ObjHeader* @"kfun:kotlin#<Int-box>(kotlin.Int){}kotlin.Any"(i32 [[p2]], %struct.ObjHeader** {{%[0-9]+}})
// CHECK: call void @"kfun:#foo(0:0;0:1){0\C2\A7<kotlin.Any?>;1\C2\A7<kotlin.Any?>}"(%struct.ObjHeader* [[boxedP1]], %struct.ObjHeader* [[boxedP2]])
...
// CHECK-SAME: (%struct.ObjHeader* [[this:%[0-9]+]], %struct.ObjHeader* [[p1:%[0-9]+]], %struct.ObjHeader* [[p2:%[0-9]+]], %struct.ObjHeader** {{%[0-9]+}})
// CHECK: [[unboxedP1:%[0-9]+]] = call i32 @"kfun:kotlin#<Int-unbox>(kotlin.Any){}kotlin.Int"(%struct.ObjHeader* [[p1]])
// CHECK: [[unboxedP2:%[0-9]+]] = call i32 @"kfun:kotlin#<Int-unbox>(kotlin.Any){}kotlin.Int"(%struct.ObjHeader* [[p2]])
// CHECK: call void @"kfun:$foo$FUNCTION_REFERENCE$5.invoke#internal"(%struct.ObjHeader* [[this]], i32 [[unboxedP1]], i32 [[unboxedP2]])
