...
class K2JsIrCompiler : CLICompiler<K2JSCompilerArguments>() {
    ...
    private fun processSourceModuleWithK2(
        ...
        // TODO: replace with potentially simpler JS version
        val mangler = FirJvmKotlinMangler()
        ...
        val platformIrOutput = Fir2IrConverter.createModuleFragmentWithSignaturesIfNeeded(
            ...
            generateSignatures = false,
            kotlinBuiltIns = builtIns,
            dependentComponents = listOfNotNull(commonIrOutput?.components),
        ...
        if (arguments.irProduceKlibDir || arguments.irProduceKlibFile) {
            ...
            commonFirOutput?.fir?.forEach {
                sourceFiles.addIfNotNull(it.sourceFile)
