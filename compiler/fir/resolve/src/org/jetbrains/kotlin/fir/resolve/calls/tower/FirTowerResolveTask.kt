...
internal abstract class FirBaseTowerResolveTask(
    ...
    protected fun FirScope.toScopeTowerLevelByImplicitStaticLookupTag(
        staticOwnerLookupTag: ConeClassLikeLookupTag? = null,
        ...
        staticOwnerLookupTag?.toSymbol(components.session)?.let {
    ...
    protected inline fun enumerateTowerLevels(
        ...
        onScope: (FirScope, ConeClassLikeLookupTag?, TowerGroup) -> Unit,
        ...
        for ((depth, lexical) in towerDataElementsForName.nonLocalTowerDataElements.withIndex()) {
            ...
            val ownerLookupTag = lexical.ownerLookupTag
...
internal open class FirTowerResolveTask(
    ...
    suspend fun runResolverForNoReceiver(
        ...
        enumerateTowerLevels(
            onScope = l@{ scope, ownerLookupTag, group ->
                ...
                processLevel(
                    scope.toScopeTowerLevelByImplicitStaticLookupTag(
                        staticOwnerLookupTag = ownerLookupTag, source = info.callSite.source
                    ),
                    info, group,
                    onEmptyLevel = {
                        emptyScopes += scope
